        ...
        <div className="flex justify-center">
          ...
          <div className="w-full lg:w-10/12 xl:w-8/12 2xl:w-7/12 text-center relative">
            ...
            <div className="rts-scholarship-info">
              ...
              <h1 className="rts-section-title text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-6 lg:mb-8 xl:mb-10 bg-gradient-to-r from-[#ad4a16] via-[#8f3a17] to-[#312518] bg-clip-text text-transparent leading-tight">
