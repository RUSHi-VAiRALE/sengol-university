      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 max-w-[1400px] relative">
        ...
        >
          <div className="inline-flex items-center gap-3 lg:gap-4 xl:gap-5 bg-gradient-to-r from-[#D4AF37]/20 to-[#B8860B]/20 backdrop-blur-sm border border-[#D4AF37]/30 px-6 lg:px-8 xl:px-10 py-3 lg:py-4 xl:py-5 rounded-full mb-6 lg:mb-8 xl:mb-10">
            <FaTrophy className="text-[#D4AF37] text-lg lg:text-xl xl:text-2xl" />
          ...
          <div className="w-32 lg:w-40 xl:w-48 h-2 lg:h-3 xl:h-4 bg-gradient-to-r from-[#D4AF37] to-[#B8860B] mx-auto mb-8 lg:mb-10 xl:mb-12 rounded-full shadow-lg"></div>
              ...
              <div className="relative group w-full">
                ...
                <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-sm h-full rounded-3xl p-8 lg:p-12 xl:p-16 2xl:p-20 transform transition-all duration-500 
                  ...
                  <div className="text-center relative">
                    <h3 className="text-[#B8860B] text-base sm:text-lg lg:text-xl xl:text-2xl font-bold mb-4 lg:mb-5 xl:mb-6 uppercase tracking-wider">
                      {fact.subtitle}
                    </h3>
                    <h2 className="text-5xl sm:text-6xl lg:text-8xl xl:text-9xl 2xl:text-[10rem] font-bold mb-6 lg:mb-8 xl:mb-10 bg-gradient-to-r from-[#D4AF37] to-[#B8860B] bg-clip-text text-transparent leading-none">
                      {fact.title}
                    </h2>
                    <div className="w-20 lg:w-24 xl:w-28 h-1.5 lg:h-2 xl:h-3 bg-gradient-to-r from-[#D4AF37] to-[#B8860B] mx-auto mb-6 lg:mb-8 xl:mb-10 rounded-full shadow-md"></div>
                  ...
                  {/* Enhanced Decorative Elements */}
                  <div className="absolute top-6 lg:top-8 xl:top-10 left-6 lg:left-8 xl:left-10 w-4 h-4 lg:w-6 lg:h-6 xl:w-8 xl:h-8 border-t-2 lg:border-t-3 xl:border-t-4 border-l-2 lg:border-l-3 xl:border-l-4 border-[#D4AF37] opacity-30 group-hover:opacity-60 transition-opacity duration-300"></div>
                  <div className="absolute top-6 lg:top-8 xl:top-10 right-6 lg:right-8 xl:right-10 w-4 h-4 lg:w-6 lg:h-6 xl:w-8 xl:h-8 border-t-2 lg:border-t-3 xl:border-t-4 border-r-2 lg:border-r-3 xl:border-r-4 border-[#D4AF37] opacity-30 group-hover:opacity-60 transition-opacity duration-300"></div>
                  <div className="absolute bottom-6 lg:bottom-8 xl:bottom-10 left-6 lg:left-8 xl:left-10 w-4 h-4 lg:w-6 lg:h-6 xl:w-8 xl:h-8 border-b-2 lg:border-b-3 xl:border-b-4 border-l-2 lg:border-l-3 xl:border-l-4 border-[#D4AF37] opacity-30 group-hover:opacity-60 transition-opacity duration-300"></div>
                  <div className="absolute bottom-6 lg:bottom-8 xl:bottom-10 right-6 lg:right-8 xl:right-10 w-4 h-4 lg:w-6 lg:h-6 xl:w-8 xl:h-8 border-b-2 lg:border-b-3 xl:border-b-4 border-r-2 lg:border-r-3 xl:border-r-4 border-[#D4AF37] opacity-30 group-hover:opacity-60 transition-opacity duration-300"></div>

                  {/* Floating Accent */}
                  <div className="absolute -top-2 lg:-top-3 xl:-top-4 -right-2 lg:-right-3 xl:-right-4 w-6 h-6 lg:w-8 lg:h-8 xl:w-10 xl:h-10 bg-gradient-to-r from-[#D4AF37] to-[#B8860B] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
                </div>
              </div>
            </motion.div>
          ))}
