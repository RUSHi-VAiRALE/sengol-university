    ...
    <section className="py-20 lg:py-28 xl:py-36 2xl:py-44 bg-gradient-to-br from-[#fffaf2] via-[#f8f4ec] to-[#f7f1e6] relative overflow-hidden">
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 max-w-[1400px] relative">
        ...
        <div className="text-center mb-16 lg:mb-20 xl:mb-24 2xl:mb-28">
          ...
          <h2 className="rts__section--title text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-6 lg:mb-8 xl:mb-10 bg-gradient-to-r from-[#D4AF37] via-[#B8860B] to-[#D4AF37] bg-clip-text text-transparent leading-tight">
            Alumni Testimonials
          </h2>
        ...
        <div className="mx-auto relative">
          <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-[#D4AF37]/20 hover:shadow-3xl hover:border-[#D4AF37]/40 transition-all duration-500">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 bg-gradient-to-br from-[#fffaf2]/80 to-[#f8f4ec]/60 p-12 lg:p-16 xl:p-20 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-80 h-80 lg:w-96 lg:h-96 xl:w-[28rem] xl:h-[28rem] bg-gradient-to-br from-[#D4AF37]/20 to-[#B8860B]/15 rounded-full mx-auto mb-6 lg:mb-8 xl:mb-10 flex items-center justify-center border-4 lg:border-6 xl:border-8 border-white shadow-2xl relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/10 to-[#B8860B]/10 rounded-full"></div>
                  ...
                  <p className="text-gray-600 bg-gradient-to-r from-white/90 to-white/70 backdrop-blur-sm px-4 lg:px-6 xl:px-8 py-2 lg:py-3 xl:py-4 rounded-full text-sm lg:text-base xl:text-lg font-medium shadow-lg border border-[#D4AF37]/20">
              ...
              <div className="lg:w-1/2 p-12 lg:p-16 xl:p-20 flex flex-col justify-center relative bg-gradient-to-br from-[#D4AF37] via-[#B8860B] to-[#CD853F]">
            ...
            <div className="absolute inset-y-0 left-0 flex items-center">
              <button
                ...
                className="bg-gradient-to-r from-white/90 to-white/80 backdrop-blur-sm hover:from-white hover:to-white text-gray-800 p-3 lg:p-4 xl:p-5 rounded-r-lg shadow-xl hover:shadow-2xl transition-all duration-300 border border-[#D4AF37]/20 hover:border-[#D4AF37]/40 hover:scale-110"
              >
            ...
            <div className="absolute inset-y-0 right-0 flex items-center">
              <button
                ...
                className="bg-gradient-to-r from-white/90 to-white/80 backdrop-blur-sm hover:from-white hover:to-white text-gray-800 p-3 lg:p-4 xl:p-5 rounded-l-lg shadow-xl hover:shadow-2xl transition-all duration-300 border border-[#D4AF37]/20 hover:border-[#D4AF37]/40 hover:scale-110"
              >
