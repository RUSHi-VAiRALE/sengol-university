...
import DirectorImage from "../../../../public/images/faculty/03.jpg";

const RegistrarMessage = () => {
  const messagePoints = [
    {
      icon: "🎯",
      title: "Academic Excellence & Integrity",
      content: "It is my pleasure to welcome you to Sengol International University, a place where academic excellence meets integrity, and innovation is nurtured with care and commitment."
    },
    {
      icon: "📊",
      title: "Transparent Governance",
      content: "As the Registrar, I am proud to be part of a university that is dedicated not only to imparting quality education but also to fostering a culture of transparency, discipline, and student-centric governance. Our administrative systems are designed to be efficient, accessible, and responsive."
    },
    {
      icon: "🤝",
      title: "Comprehensive Support",
      content: "Our goal is to support the academic mission of the university through seamless administrative services, accurate record keeping, and the facilitation of student welfare initiatives. Whether you are a student, parent, faculty member, or partner institution, we are here to provide you with timely assistance and guidance."
    },
    {
      icon: "🌱",
      title: "Growing Excellence",
      content: "Sengol International University is growing rapidly as a center of learning in Sikkim, and we are committed to upholding the values that define us: integrity, inclusiveness, innovation, and service. We strive to make every interaction meaningful and every process transparent."
    }
  ];
          ...
          <div className="flex-1">
            <div className="bg-gradient-to-r from-[#ad4a16]/5 via-[#8f3a17]/5 to-[#312518]/5 rounded-2xl lg:rounded-3xl p-6 lg:p-8 xl:p-10 border border-[#ad4a16]/10 mb-8 lg:mb-10 xl:mb-12">
              <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl text-gray-700 leading-relaxed italic">
                "I invite you to explore all that Sengol International University has to offer and look forward to being part of your academic journey."
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <blockquote className="text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold leading-relaxed italic">
              "Leadership begins with learning. We are here to lead with knowledge, compassion, and courage."
            </blockquote>
          </div>
        </motion.div>
      </div>
