...
import { FaChartLine, FaBriefcase, FaGlobe, FaHandshake } from "react-icons/fa";
import ProgramsTabs from "@/components/program/ProgramTabs";
import { CommerceManagementData } from "@/data-store/ProgramData";
import ProgramInfo from "@/components/program/ProgramInfo";

const CommerceManagementProgram = () => {
  const {
    bachelorsData,
    certificateData,
    diplomaData,
  ...
  const highlights = [
    {
      ...
      description: "Master data-driven decision making and business intelligence for modern enterprises."
    },
    {
      icon: FaBriefcase,
      title: "Leadership Skills",
      description: "Develop essential management and leadership capabilities for corporate success."
    },
    {
      icon: FaGlobe,
      title: "Global Perspective",
      description: "Understand international business practices and global market dynamics."
    },
    {
      icon: FaHandshake,
      title: "Industry Connect",
      description: "Strong industry partnerships providing internships and placement opportunities."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaChartLine className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Discover our comprehensive business and management programs tailored for modern industry needs.
          </p>
        </div>
...
export default CommerceManagementProgram;
