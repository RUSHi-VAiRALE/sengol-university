...
import { FaPills, FaFlask, FaUserMd, FaLeaf } from "react-icons/fa";
  ...
  const highlights = [
    {
      ...
      description: "Study drug development, pharmacology, and pharmaceutical chemistry for modern medicine."
    },
    {
      icon: FaFlask,
      title: "Drug Research",
      description: "Engage in pharmaceutical research, drug discovery, and clinical trial methodologies."
    },
    {
      icon: FaUserMd,
      title: "Clinical Pharmacy",
      description: "Learn patient care, medication therapy management, and clinical consultation."
    },
    {
      icon: FaLeaf,
      title: "Herbal Medicine",
      description: "Explore traditional and modern approaches to herbal and natural product pharmacy."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaPills className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our pharmacy programs designed for pharmaceutical professionals and researchers.
          </p>
        </div>
