...
import { FaHeartbeat, FaStethoscope, FaMicroscope, FaAmbulance } from "react-icons/fa";
import ProgramsTabs from "@/components/program/ProgramTabs";
import { ParaMedicalData } from "@/data-store/ProgramData";
import ProgramInfo from "@/components/program/ProgramInfo";

const ParaMedicalProgram = () => {
  const {
    bachelorsData,
    pgDiplomaData,
    certificateData,
  ...
  const tabDetails = [
    ...
    { key: "5", tab: "PG DIPLOMA PROGRAM", data: pgDiplomaData },
  ];
  ...
  const highlights = [
    {
      ...
      description: "Develop expertise in patient care, medical procedures, and healthcare management."
    },
    {
      icon: FaStethoscope,
      title: "Clinical Training",
      description: "Gain hands-on experience in clinical settings with modern medical equipment."
    },
    {
      icon: FaMicroscope,
      title: "Medical Technology",
      description: "Master diagnostic techniques, laboratory procedures, and medical imaging."
    },
    {
      icon: FaAmbulance,
      title: "Emergency Care",
      description: "Learn emergency medical services, trauma care, and critical patient management."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaHeartbeat className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our para-medical programs designed for healthcare professionals and medical technicians.
          </p>
        </div>
...
export default ParaMedicalProgram;
