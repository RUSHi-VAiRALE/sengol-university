...
import { FaBook, FaDatabase, FaSearch, FaDigitalTachograph } from "react-icons/fa";
  ...
  const highlights = [
    {
      ...
      description: "Master the organization, cataloging, and management of information resources and collections."
    },
    {
      icon: FaDatabase,
      title: "Digital Libraries",
      description: "Learn modern digital library systems, database management, and electronic resource organization."
    },
    {
      icon: FaSearch,
      title: "Research Methods",
      description: "Develop advanced research skills and information retrieval techniques for academic excellence."
    },
    {
      icon: FaDigitalTachograph,
      title: "Technology Integration",
      description: "Integrate cutting-edge technology solutions in library and information science practices."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaBook className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Discover our library and information science programs for the digital age.
          </p>
        </div>
