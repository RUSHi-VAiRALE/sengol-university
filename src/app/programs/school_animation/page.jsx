...
import { FaPlay, FaPaintBrush, FaFilm, FaGamepad } from "react-icons/fa";
  ...
  const highlights = [
    {
      ...
      description: "Master traditional and digital animation techniques using industry-standard software."
    },
    {
      icon: FaPaintBrush,
      title: "Digital Art",
      description: "Develop artistic skills in character design, concept art, and visual storytelling."
    },
    {
      icon: FaFilm,
      title: "Motion Graphics",
      description: "Create compelling motion graphics, visual effects, and multimedia presentations."
    },
    {
      icon: FaGamepad,
      title: "Game Design",
      description: "Learn game development, interactive media, and virtual reality applications."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaPlay className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our animation and multimedia programs for creative professionals in digital media.
          </p>
        </div>
