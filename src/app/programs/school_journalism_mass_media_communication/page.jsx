...
import { FaNewspaper, FaVideo, FaMicrophone, FaBroadcastTower } from "react-icons/fa";
import ProgramsTabs from "@/components/program/ProgramTabs";
import { JournalismMassCommunicationData } from "@/data-store/ProgramData";
import ProgramInfo from "@/components/program/ProgramInfo";

const JournalismMassCommunicationProgram = () => {
  const {
    bachelorsData,
    certificateData,
    diplomaData,
    ...
    objectives,
    objectiveIntro,
  } = JournalismMassCommunicationData;
  ...
  const highlights = [
    {
      ...
      description: "Master the art of news writing, investigative reporting, and editorial journalism for print media."
    },
    {
      icon: FaVideo,
      title: "Digital Media",
      description: "Learn multimedia storytelling, video production, and digital content creation for modern platforms."
    },
    {
      icon: FaMicrophone,
      title: "Broadcasting",
      description: "Develop skills in radio and television broadcasting, anchoring, and live reporting."
    },
    {
      icon: FaBroadcastTower,
      title: "Mass Communication",
      description: "Understand media theory, public relations, advertising, and strategic communication."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaNewspaper className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our journalism and mass communication programs for aspiring media professionals.
          </p>
        </div>
...
export default JournalismMassCommunicationProgram;
