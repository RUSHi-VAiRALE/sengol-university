  ...
  const highlights = [
    {
      ...
      description: "Pursue advanced research leading to PhD degrees across multiple disciplines."
    },
    {
      icon: FaSearch,
      title: "Research Innovation",
      description: "Conduct groundbreaking research with state-of-the-art facilities and expert guidance."
    },
    {
      icon: FaBookOpen,
      title: "Academic Scholarship",
      description: "Develop deep theoretical knowledge and contribute to academic literature."
    },
    {
      icon: FaLightbulb,
      title: "Knowledge Creation",
      description: "Generate new knowledge and innovative solutions to complex problems."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-gradient-to-r from-[#ad4a16] via-[#8f3a17] to-[#312518] bg-clip-text text-transparent leading-tight">
          School of Philosophy and Research
        </h1>
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our doctoral and research programs for advanced academic and professional development.
          </p>
        </div>
