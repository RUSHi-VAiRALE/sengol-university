...
import { CSITData } from "@/data-store/ProgramData";
  ...
  const highlights = [
    {
      ...
      description: "Learn cutting-edge programming languages and frameworks used in today's tech industry."
    },
    {
      icon: FaRobot,
      title: "AI & Machine Learning",
      description: "Explore artificial intelligence, machine learning, and data science applications."
    },
    {
      icon: FaCloud,
      title: "Cloud Computing",
      description: "Master cloud technologies, DevOps practices, and scalable system architecture."
    },
    {
      icon: FaShieldAlt,
      title: "Cybersecurity",
      description: "Develop expertise in information security, ethical hacking, and digital forensics."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaCode className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our comprehensive computer science and IT programs designed for the digital age.
          </p>
        </div>
