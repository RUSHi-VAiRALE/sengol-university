...
import { FaPalette, FaHistory, FaUsers, FaGlobe } from "react-icons/fa";
import ProgramsTabs from "@/components/program/ProgramTabs";
import { ArtSocialStudiesData } from "@/data-store/ProgramData";
  ...
  const highlights = [
    {
      icon: FaPalette,
      title: "Creative Arts",
      description: "Explore various forms of artistic expression including visual arts, literature, and performing arts."
    },
    {
      icon: FaHistory,
      title: "Historical Studies",
      description: "Understand historical contexts, cultural heritage, and their impact on contemporary society."
    },
    {
      icon: FaUsers,
      title: "Social Sciences",
      description: "Study human behavior, social structures, and societal dynamics through interdisciplinary approaches."
    },
    {
      icon: FaGlobe,
      title: "Cultural Studies",
      description: "Examine diverse cultures, traditions, and their influence on global perspectives."
    }
  ];
    ...
    <div className="space-y-12 lg:space-y-16">
      ...
      >
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ad4a16]/20 via-[#8f3a17]/15 to-[#312518]/20 backdrop-blur-sm border border-[#ad4a16]/30 px-6 py-3 rounded-full">
          <FaPalette className="text-[#ad4a16] text-lg" />
      ...
      >
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base lg:text-lg">
            Explore our arts and social studies programs that nurture creativity and critical thinking.
          </p>
        </div>
